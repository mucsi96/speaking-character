...
unlock:
  ...
  text: "Coco: „4-6-8 — nur noch EIN Schloss bis zum Schatz!”"
  gradient: "linear-gradient(90deg,#3a9c66,var(--lock-green))"
break:
  emoji: "🧀"
  title: SZÜNET 2
  text: "Snack + 1 Tom & Jerry rész. Készítsd elő a finálét (nappali, előszoba, láda köré)."
---
