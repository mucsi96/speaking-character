...
/**
 * Fallback cartoon pirate parrot built entirely from geometry primitives, used
 * when the GLB model isn't present. Classic red macaw with an eye patch and a
 * tricorn-ish hat; the lower beak opens with the narration amplitude.
 */
export function ProceduralParrot() {
